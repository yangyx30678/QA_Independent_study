...
def main(huggingface_name, model_name=None, train_set=None, dev_set=None, test_set=None, ep=2, device='cpu'):
    ...
    def loss_func(scores, labels):
        ...
        for i in range(s.size(0)):
            ...
            #     total_loss += torch.nn.CrossEntropyLoss()(s[i], sl[i])train_set
    ...
    for epoch in range(epochs):
        ...
        if test_set != None:
            ...
            torch.save(model, f'./saved_model/model_final{epoch}')
...
if __name__ == '__main__':
    ...
    model_names = [
        ...
        ['hfl/chinese-lert-base', 'lertsampled6000_1.1', 'cuda:2']
